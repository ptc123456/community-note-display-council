...
- Pending challenge boundary: no `resolve_challenges(3)` write is allowed before `1787492521`; resolution, finalization, and final reputation readback remain pending and are not claimed as PASS.
